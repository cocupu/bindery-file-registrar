...
test('export entire db to json', function (t) {
  ...
  return bfr.register(__dirname + "/data")
  .then(function(entityInfo) {
    bfr.exportDb({}, function (json) {
      ...
      t.same(subDirEntry.birthtime, '2016-05-20T21:41:53.000Z', "stores birthtime")
      t.same(subDirEntry.mtime, '2016-05-20T21:41:53.000Z', "stores mtime")
